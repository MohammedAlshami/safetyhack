interface ButtonProps {
  ...
  export const LevelsButton: React.FC<ButtonProps> = ({
    children,
    componentWidth,
  }) => {
    return (
      <div
        className={`bg-[#FBEB00] h-24 ${componentWidth} rounded-lg border border-[4px] border-black py-2 cursor-pointer transition-transform hover:-translate-y-1`}
      >
        <div
